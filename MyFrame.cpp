...
{
    wxMessageBox(wxT("Эта программа помогает составить список покупок и рассчитать примерный бюджет. После составления списка вы можете его сохранить и/или распечатать."),
